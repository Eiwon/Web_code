...
<body>
	...
	* JSTL (JSP Standard Tag Library)
	- JSP 태그의 경우 HTML 태그의 가독성을 떨어뜨리기 때문에 JSTL 사용
	- JSP의 다양한 커스텀 태크를 모아놓은 라이브러리
	- 반복, 조건, SQL 등 기능 제공
	...
	* JSTL 라이브러리 추가
	...
	- jakarta-taglibs-standard-1.1.2/lib 경로의 jstl.jar, standard.jar 파일을 
		해당 프로젝트 Web_inf/lib 폴더에 저장.
	- 필요한 taglib을 URL로 지정
	 --%>
</body>
</html>
